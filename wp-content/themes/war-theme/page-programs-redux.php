			...
			?>
				<div id = "ProgramsRedux">
					<ul class = "ProgramCategories2">
						...
						<a href="http://www.warinternational.org/program-list/?International"><li class = "ProgramCatb InternationalButton">
							<p>INTERNATIONAL SAFEHOUSES</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Domestic"><li class = "ProgramCatb DomesticButton">
							<p>DOMESTIC SAFEHOUSES</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Vocational"><li class = "ProgramCatb VocationalButton">
							<p>VOCATIONAL TRAINING</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Micro"><li class = "ProgramCatb MicroButton">
							<p>MICROENTERPRISE</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Education"><li class = "ProgramCatb EducationButton">
							<p>EDUCATION</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Orphanages"><li class = "ProgramCatb OrphanButton">
							<p>ORPHANAGES</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Outreach"><li class = "ProgramCatb OutreachButton">
							<p>OUTREACH</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Health"><li class = "ProgramCatb HealthButton">
							<p>MEDICAL AID</p>
						</li></a>
						<a href="http://www.warinternational.org/program-list/?Emergency"><li class = "ProgramCatb EmergencyButton">
