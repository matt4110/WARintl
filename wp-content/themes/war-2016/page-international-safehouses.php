	...
	<div id="content" role="main">
		<div id = "InternationalSafehouses" class="container">
			<div class ="quote text-center">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">"The ache for home lives in all of us, the safe place</div>
				</div>
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">where we can go as we are and not be questioned."</div>
				</div>
				<div class="row">
