	...
	<div id="container">
		<div id="content" role="main" style="color:black;">
			...
			<div class="row">
				...
				?>
				<div class="col-md-12 col-sm-12 col-xs-12 text-center" style="font-size:2em; font-weight:bold;"><img src="<?php echo $imageAttributes[0]; ?>" style="margin-right:10px; width: 72px; height:50px;"></img><?php echo get_the_title($firstCountry);?></div>
			</div>
			<div class="row">
