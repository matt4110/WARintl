(function($){
    SlideDeckLens['my-lens'] = function(slidedeck){
        var ns = 'my-lens';
    ...
    $(document).ready(function(){
        $('.lens-my-lens .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-my-lens')) == 'undefined' || $.data(this, 'lens-my-lens') == null){
                $.data(this, 'lens-my-lens', new SlideDeckLens['my-lens'](this));
            }
        });
    });
})(jQuery);